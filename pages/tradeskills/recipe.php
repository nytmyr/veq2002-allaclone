...
$query = "SELECT *
			...
			WHERE id=$id
			ORDER BY $trade_skill_recipe_table.name ASC";
...
$tradeskill = ""; 
$recipe["tradeskill"] == 75 ? $tradeskill = "None" : $tradeskill = ucfirstwords($dbskills[$recipe["tradeskill"]]);
$print_buffer .= "<b>Recipe: </b>" . ucfirstwords(str_replace('_', ' ', $recipe["name"])) . "<br>";
$print_buffer .= "<b>Tradeskill: </b>" . $tradeskill . "<br>";
