...
if (!isset($_GET['v_tooltip'])) {
	...
	$content .= return_where_item_summoned_by_spell($item_id);
	$content .= return_where_item_summoned_by_item($item_id);
	$content .= return_where_item_used_trade_skills($item_id);	
    $content .= return_where_item_result_trade_skill($item_id);
	$content .= return_where_item_container_trade_skills($item_id);
}
