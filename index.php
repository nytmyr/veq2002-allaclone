...
<head>
    ...
    <title>VegasEQ Allakhazam</title>
                                ...
                                <div style="width:100%; overflow: hidden;">
                                    <div class="side_menu" style="width:200px; display: inline-block; float: left;">
                                        <table border="0">
											...
											<tr>
                                                <td class="menuh" nowrap="1">Getting Started...</td>
                                            </tr>
                                            <tr>
                                                <td nowrap="1" class="menu_item">
                                                    <li><a href="?a=server_features">Server Features</a></li>
													<li><a href="?a=bot_info">Bot Information</a></li>
                                                    </li>
                                                </td>
                                            </tr>
                                            <tr>
											...
											<!-- <tr>
                                                <td class="menuh" nowrap="1">Vegas Loot...</td>
                                            </tr>
                                            <tr>
                                                <td  class="menu_item">
                                                    <li><a href="?a=vegas_loot">Vegas Loot</a></li>
                                                </td>
                                            </tr>
                                            </tbody> -->
                                        </table>
